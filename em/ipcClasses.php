<?php
    ...
    // local timezone for bhd-solutions.com
    //$local_timezone = "America/Los_Angeles";
    // for Round Rock Office
    $local_timezone = "America/Chicago";

    // common classes
    include "../class/ipcAlmClass.php";
    include "../class/ipcAlmReportClass.php";
    include "../class/ipcBatchExcClass.php";
    include "../class/ipcBrdcstClass.php";
    include "../class/ipcCfglogClass.php";
    ...
    include "../class/ipcFtModTableClass.php";

      ...
      <div class="col-md-6">
        <div id="node-x-table" class="nav-tabs-custom" shelf="x">
          ...
          <div class="tab-content mio-tabs">
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="btn-group" data-toggle="buttons">
                    <button type="radio" class="btn btn-default active">MIOX-1</button>
                    <button type="radio" class="btn btn-default">MIOX-2</button>
                    <button type="radio" class="btn btn-default">MIOX-3</button>
                    <button type="radio" class="btn btn-default">MIOX-4</button>
                    <button type="radio" class="btn btn-default">MIOX-5</button>
                    <button type="radio" class="btn btn-default">MIOX-6</button>
                    <button type="radio" class="btn btn-default">MIOX-7</button>
                    <button type="radio" class="btn btn-default">MIOX-8</button>
                    <button type="radio" class="btn btn-default">MIOX-9</button>
                    <button type="radio" class="btn btn-default">MIOX-10</button>
                  </div>
                </div>
                <div class="row">
                  <div class="btn-group">
                ...
                <div class="row port-grid">
                  ...
                  <div class="info-box bg-yellow">
                    <div class="info-box-text">
                      1-1-X-1
                      <span class="pull-right">MTCD</span>
                    </div>
                    <div class="info-box-text">
                      1-001
                      <span class="pull-right">OE</span>
                    </div>
                  ...
                  <div class="info-box bg-aqua">
                    <div class="info-box-text">
                      1-1-X-2
                      <span class="pull-right">UAS</span>
                    </div>
                    <div class="info-box-text">
                      -
                  ...
                  <div class="info-box bg-green">
                    <div class="info-box-text">
                      1-1-X-6
                      <span class="pull-right">CONN</span>
                    </div>
                    <div class="info-box-text">
                      1-006
                      <span class="pull-right">CP</span>
                    </div>
                    <div class="info-box-text text-center">
                      555-555-5555
                    </div>
            ...
            <div class="tab-pane" id="nodex2">
              <h1>Node 2</h1>
            </div>
            <div class="tab-pane" id="nodex3">
              <h1>Node 3</h1>
            </div>
            <div class="tab-pane" id="nodex4">
              <h1>Node 4</h1>
            </div>
            <div class="tab-pane" id="nodex5">
              <h1>Node 5</h1>
            </div>
            <div class="tab-pane" id="nodex6">
              <h1>Node 6</h1>
            </div>
            <div class="tab-pane" id="nodex7">
              <h1>Node 7</h1>
            </div>
            <div class="tab-pane" id="nodex8">
              <h1>Node 8</h1>
            </div>
            <div class="tab-pane" id="nodex9">
              <h1>Node 9</h1>
            </div>
            <div class="tab-pane" id="nodex10">
              <h1>Node 10</h1>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-6">
        <div id="node-y-table" class="nav-tabs-custom" shelf="y">
          ...
          <div class="tab-content mio-tabs">
              ...
              <div class="container-fluid">
                ...
                <div class="row port-grid">
                  ...
                  <div class="info-box bg-gray-active">
                    <div class="info-box-text">
                      1-1-Y-1
                      <span class="pull-right">OOS</span>
                    </div>
                    <div class="info-box-text">
                      100-0-00-00
                      <span class="pull-right">OE</span>
                  ...
                  <div class="info-box bg-gray-active">
                    <div class="info-box-text">
                      1-1-Y-2
                      <span class="pull-right">UNQ</span>
                    </div>
                    <div class="info-box-text">
                      -
                      <span class="pull-right">-</span>
            ...
            <div class="tab-pane" id="nodey2">
              <h1>Node 2</h1>
            </div>
            <div class="tab-pane" id="nodey3">
              <h1>Node 3</h1>
            </div>
            <div class="tab-pane" id="nodey4">
              <h1>Node 4</h1>
            </div>
            <div class="tab-pane" id="nodey5">
              <h1>Node 5</h1>
            </div>
            <div class="tab-pane" id="nodey6">
              <h1>Node 6</h1>
            </div>
            <div class="tab-pane" id="nodey7">
              <h1>Node 7</h1>
            </div>
            <div class="tab-pane" id="nodey8">
              <h1>Node 8</h1>
            </div>
            <div class="tab-pane" id="nodey9">
              <h1>Node 9</h1>
            </div>
            <div class="tab-pane" id="nodey10">
              <h1>Node 10</h1>
            </div>
          </div>
        </div>
